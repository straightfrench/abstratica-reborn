  ...
  return (
    <div>
      ...
      <div className={styles.maincontainer}>
        ...
        <RoadmapCard header="4. Start bringing Abstratica closer to the 1:1 art scene. It's where we belong." text={["By step four, we will have built up our name again and started earning more royalties! We will use these royalties to buy 1:1 art from reputable artists in the space and auction it off (for Abstratica hodlers only) or run raffles which can be entered using $ABS. All on our own website!"]}/>
        <RoadmapCard header="5. Collaborate with top tier 1:1 artists to celebrate 1 year of art on Solana with an exclusive NFT release, launched on abstratica.art." text={["This is our big ambitious target and the thing we are most excited about!", "Get ready for auctions of amazing art held in $ABS. We have already recieved willingness to participate from a few very tallented artists!", "If you are an OG 1:1 artist and want to take part in this celebration of 1 year of art on Solana, reach out to us!"]} />
      </div>
    </div>
  );
}
